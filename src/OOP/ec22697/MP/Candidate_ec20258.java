...
/*            // most common winner
            void mostCommonWinner(Candidate[] voters, Candidate[] ballotBox){
                for (Candidate c : voters) {
                    if(c != null){
                        Candidate winner = c.selectWinner(ballotBox);
                        if(winner != null){
                            System.out.println(c.getName() +" says " + winner.getName() +
                                    " wins the election.");
                        }
                    }
                }
