package OOP.ec22697.MP;// File Candidate_ec21499.java
//
...
public class Candidate_ec21499 extends Candidate {
    ...
    public static void election_menu(Candidate[] all_candidates) {
        ...
        while (true){
            ...
            System.out.println("1) add a specific candidate");
            System.out.println("2) add a candidate at random");
            System.out.println("3) run the election?");
    ...
    public Candidate vote(Candidate[] candidate_list) {
        ...
        for (Candidate c : candidate_list) {
            if (c.getSlogan().equals("Your friendly neighbourhood Spiderman")){
                return c;
            }
        }
            
        for (Candidate c : candidate_list){
            if (c.getName().equals("Peter Parker")){
                return c;
            }
        }
